...
def traverseRoomsDFS(room, visitedRooms,roomSequence):
    ...
    for direction in room.get_exits():
        roomInDir = room.get_room_in_direction(direction)
...
def findShortestPath(start, end, path):
    ...
    while q:
        room = q.pop()
        for dir in room.get_exits_string():
            nR = room.get_room_in_direction(dir)
...
#Start of solution
print("Starting from ",player.current_room)

#Run DFS starting from starting in recursive manner.
visitedRooms[player.current_room] = True
traverseRoomsDFS(player.current_room, visitedRooms,roomSequence)
...
for move in traversalPath:
    print ("from ", player.current_room.id, "move to ", move, " reach ",)
    player.travel(move)
